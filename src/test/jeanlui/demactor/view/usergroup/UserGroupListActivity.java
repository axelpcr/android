/**************************************************************************
 * UserGroupListActivity.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
public class UserGroupListActivity 
    ...
    protected int getContentView() {
        return R.layout.activity_usergroup_list;
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (this.isDualMode()) {
            ...
            final UserGroup item = UserGroupContract
                    .cursorToItem((android.database.Cursor)
                            l.getItemAtPosition(position));
            Bundle extras = new Bundle();
            extras.putParcelable(UserGroupContract.PARCEL, item);
    ...
    private void selectListItem(int listPosition) {
        ...
        if (listSize > 0) {
            ...
            UserGroup item = UserGroupContract.cursorToItem(
