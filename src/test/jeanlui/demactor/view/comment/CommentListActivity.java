/**************************************************************************
 * CommentListActivity.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/**
 * This class will display Comment entities in a list.
 *
 * This activity has a different behaviour wether you're on a tablet or a phone.
 * - On a phone, you will have a Comment list. A click on an item will get 
 * you to CommentShowActivity.
 * - On a tablet, the CommentShowFragment will be displayed right next to
 * the list.
 */
public class CommentListActivity 
    ...
    protected CommentListFragment listFragment;
    /** Associated detail fragment if any (in case of tablet). */
    protected CommentShowFragment detailFragment;
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        this.detailFragment = (CommentShowFragment) 
                        this.getSupportFragmentManager().findFragmentById(
                                R.id.fragment_show);
        this.listFragment = (CommentListFragment)
                        this.getSupportFragmentManager().findFragmentById(
                                R.id.fragment_list);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (this.isDualMode()) {
            ...
            final Intent intent = new Intent(this, CommentShowActivity.class);
            final Comment item = CommentContract
                    .cursorToItem((android.database.Cursor)
                            l.getItemAtPosition(position));
            Bundle extras = new Bundle();
            extras.putParcelable(CommentContract.PARCEL, item);
     ...
     */
    private void loadDetailFragment(Comment item) {
    ...
    private void selectListItem(int listPosition) {
        ...
        if (listSize > 0) {
            ...
            Comment item = CommentContract.cursorToItem(
