/**************************************************************************
 * CommentListFragment.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 * This fragment gives you an interface to list all your Comments.
 *
 * @see android.app.Fragment
 */
public class CommentListFragment
        extends HarmonyListFragment<Comment>
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_comment_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.commentProgressLayout,
                R.id.commentListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.comment_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new CommentListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new CommentListLoader(this.getActivity(),
