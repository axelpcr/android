/**************************************************************************
 * PostListActivity.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/**
 * This class will display Post entities in a list.
 *
 * This activity has a different behaviour wether you're on a tablet or a phone.
 * - On a phone, you will have a Post list. A click on an item will get 
 * you to PostShowActivity.
 * - On a tablet, the PostShowFragment will be displayed right next to
 * the list.
 */
public class PostListActivity 
    ...
    protected PostListFragment listFragment;
    /** Associated detail fragment if any (in case of tablet). */
    protected PostShowFragment detailFragment;
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        this.detailFragment = (PostShowFragment) 
                        this.getSupportFragmentManager().findFragmentById(
                                R.id.fragment_show);
        this.listFragment = (PostListFragment)
                        this.getSupportFragmentManager().findFragmentById(
                                R.id.fragment_list);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (this.isDualMode()) {
            ...
            final Intent intent = new Intent(this, PostShowActivity.class);
            final Post item = PostContract
                    .cursorToItem((android.database.Cursor)
                            l.getItemAtPosition(position));
            Bundle extras = new Bundle();
            extras.putParcelable(PostContract.PARCEL, item);
     ...
     */
    private void loadDetailFragment(Post item) {
    ...
    private void selectListItem(int listPosition) {
        ...
        if (listSize > 0) {
            ...
            Post item = PostContract.cursorToItem(
