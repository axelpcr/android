/**************************************************************************
 * ViewComponentCreateFragment.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 * This fragment gives you an interface to create a ViewComponent.
 */
public class ViewComponentCreateFragment extends HarmonyFragment
    ...
    protected void initializeComponent(final View view) {
        this.stringFieldView =
            (EditText) view.findViewById(R.id.viewcomponent_stringfield);
        this.textView =
            (EditText) view.findViewById(R.id.viewcomponent_text);
        this.dateTimeView =
                (DateTimeWidget) view.findViewById(R.id.viewcomponent_datetime);
        this.dateView =
                (DateWidget) view.findViewById(R.id.viewcomponent_date);
        this.timeView =
                (TimeWidget) view.findViewById(R.id.viewcomponent_time);
        this.loginView =
            (EditText) view.findViewById(R.id.viewcomponent_login);
        this.passwordView =
            (EditText) view.findViewById(R.id.viewcomponent_password);
        this.emailView =
            (EditText) view.findViewById(R.id.viewcomponent_email);
        this.phoneView =
            (EditText) view.findViewById(R.id.viewcomponent_phone);
        this.cityView =
            (EditText) view.findViewById(R.id.viewcomponent_city);
        this.zipCodeView =
            (EditText) view.findViewById(R.id.viewcomponent_zipcode);
        this.countryView =
            (EditText) view.findViewById(R.id.viewcomponent_country);
        this.byteFieldView =
            (EditText) view.findViewById(R.id.viewcomponent_bytefield);
        this.charFieldView =
            (EditText) view.findViewById(R.id.viewcomponent_charfield);
        this.shortFieldView =
            (EditText) view.findViewById(R.id.viewcomponent_shortfield);
        this.characterView =
            (EditText) view.findViewById(R.id.viewcomponent_character);
        this.choiceView =
            (EnumSpinner) view.findViewById(R.id.viewcomponent_choice);
        this.choiceView.setEnum(Choice.class);
        this.booleanObjectView =
                (CheckBox) view.findViewById(R.id.viewcomponent_booleanobject);
    }
    ...
    public View onCreateView(
        ...
        final View view = inflater.inflate(
                R.layout.fragment_viewcomponent_create,
                container,
                false);
    ...
    public static class CreateTask extends AsyncTask<Void, Void, Uri> {
         ...
         * called
         */
        public CreateTask(final ViewComponentCreateFragment fragment,
        ...
        protected Uri doInBackground(Void... params) {
            ...
            result = new ViewComponentProviderUtils(this.ctx).insert(
                        this.entity);
        ...
        protected void onPostExecute(Uri result) {
            ...
            if (result != null) {
                ...
                builder.setMessage(
                        this.ctx.getString(
                                R.string.viewcomponent_error_create));
