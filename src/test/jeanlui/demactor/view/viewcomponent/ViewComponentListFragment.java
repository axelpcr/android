/**************************************************************************
 * ViewComponentListFragment.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** ViewComponent list fragment.
 *
 * This fragment gives you an interface to list all your ViewComponents.
 *
 * @see android.app.Fragment
 */
public class ViewComponentListFragment
        extends HarmonyListFragment<ViewComponent>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected ViewComponentListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_viewcomponent_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.viewcomponentProgressLayout,
                R.id.viewcomponentListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.viewcomponent_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new ViewComponentListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new ViewComponentListLoader(this.getActivity(),
    ...
    public void onClickAdd() {
        Intent intent = new Intent(this.getActivity(),
                    ViewComponentCreateActivity.class);
