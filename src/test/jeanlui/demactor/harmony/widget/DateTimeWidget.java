/**************************************************************************
 * DateTimeWidget.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.jeanlui.demactor.harmony.widget;
...
import com.jeanlui.demactor.harmony.util.DateUtils.TimeFormatType;
        ...
        switch (arg0.getId()) {
            ...
            case R.id.time:
                ...
                if (this.timeFormat.equals(TimeFormatType.AMPM)) {
                    ...
                    format24H = DemactorApplication.is24Hour();
                }
